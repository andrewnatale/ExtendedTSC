...
from MDAextensions.analysis.getMDdensity import _getMDdensity
...
water_ox_sel = "resname SOL and name OW"

pot_sel = 'resname K'

dens_h2o = _getMDdensity(32, 32, water_ox_sel, u, grid_center=(65.0,65.0,68.0), verbose=True)
dens_h2o.run()
dens_h2o.gridobj.export('h2o_%s' % outname, file_format='dx')

dens_lipid = _getMDdensity(75, 100, lipid_hphobic_sel,u, grid_center=(65.0,65.0,68.0), verbose=True)
dens_lipid.run()
dens_lipid.gridobj.export('lipid_%s' % outname, file_format='dx')

dens_pot = _getMDdensity(20,40,pot_sel, u, grid_center=(65.0,65.0,68.0), verbose=True)
dens_pot.run()
